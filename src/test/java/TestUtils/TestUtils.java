package TestUtils;// Don't edit this file
...
public class TestUtils {
    ...
    public static void updateFieldValue(@NotNull Object object, @NotNull Field field, Object value) {
        try {
    ...
    public static <T, Q> T getFieldValue(@NotNull Q object, @NotNull Field field) {
        //T value = null;
        try {
